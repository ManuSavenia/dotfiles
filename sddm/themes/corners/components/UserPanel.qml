...
Column {
    ...
    // 🔥 POSICIÓN DEL POPUP - CENTRADO ARRIBA DEL AVATAR
    x: pictureBorder.x + (pictureBorder.width - width) / 2
    y: pictureBorder.y - height - 20
    ...
    enter: Transition {
        ParallelAnimation {
            ...
            NumberAnimation {
                property: "y"
                from: pictureBorder.y - height - 40
                to: pictureBorder.y - height - 20
                duration: 500
                easing.type: Easing.OutExpo
            }
        }
